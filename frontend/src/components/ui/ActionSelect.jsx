 ...
 * A premium select-like dropdown for table actions using Portals to prevent clipping.
 * 
 * @param {Array} actions - Array of objects: { label, icon, onClick, variant, disabled, confirm }
