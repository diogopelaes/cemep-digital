...
import {
    HiClipboardList, HiCalendar, HiExclamationCircle, HiSwitchHorizontal,
    HiBookOpen, HiUserGroup, HiPencilAlt
} from 'react-icons/hi'
            ...
            <Card>
                ...
                <CardContent>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <QuickAccessButton to="/minhas-turmas" icon={HiUserGroup} label="Minhas Turmas" color="primary" />
                        <QuickAccessButton to="/plano-aula" icon={HiBookOpen} label="Plano de Aula" color="accent" />
                        <QuickAccessButton to="/aula-faltas" icon={HiPencilAlt} label="Registro de Aulas" color="warning" />
                        <QuickAccessButton to="/avisos" icon={HiExclamationCircle} label="Avisos" color="success" />
                    </div>
                </CardContent>
            </Card>
        </div>
