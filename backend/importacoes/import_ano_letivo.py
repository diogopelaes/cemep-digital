...
# O script está em 'backend/importacoes', então a raiz do projeto (backend) é o pai.
IMPORT_DIR = Path(__file__).resolve().parent
BACKEND_DIR = IMPORT_DIR.parent
sys.path.append(str(BACKEND_DIR))

# Carrega variáveis de ambiente do .env manualmente
try:
    from dotenv import load_dotenv
    # O .env está na raiz da pasta backend
...
if __name__ == "__main__":
    ...
    JSON_FILE = IMPORT_DIR / 'dados_base' / 'config_ano_letivo_2026.json'
