...
# ============================================================
# GERAR E CARREGAR VARIÁVEIS DE AMBIENTE (.env)
# ============================================================
$SETUP_SCRIPT = Join-Path $PROJECT_ROOT "dev_work\setup-env-dev.ps1"
if (Test-Path $SETUP_SCRIPT) {
    & $SETUP_SCRIPT
}
else {
    Write-Host "AVISO: Script de setup não encontrado em $SETUP_SCRIPT. Usando .env existente se disponível." -ForegroundColor Yellow
}
